...
{
	/**
	Attributed Scope class.

	Extending Scope, This enables variables with names and is the applied version of Scope.
	An Attributed Scope can effectively be used as a runtime Class object with global and temporary variables
	and the ability to distinguish between the two.

	Can be used an abstract base class
	*/
