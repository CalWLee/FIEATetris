...
{
	/**
	Container class used to serialize/deserialize XML data.
	World is the root element in the XML File being used.

	During the course of development (one week or so), 
	the idea that multiple SharedDataWorld instances was not considered.
	*/
