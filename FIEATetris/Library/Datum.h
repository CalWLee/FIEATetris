...
namespace Library
{
	...
	Run-time polymorphic primitive. 
	Can be used an array of defined primitives or a single value.
	Can also store pointers of primitives or other tables of Datums
	*/
	class Datum
	{
	public:
